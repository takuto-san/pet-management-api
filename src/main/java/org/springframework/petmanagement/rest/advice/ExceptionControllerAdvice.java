...
public class ExceptionControllerAdvice {
    ...
    /**
     * Handles {@link IllegalArgumentException} which typically indicates invalid input or business logic violations.
     *
     * @param ex The {@link IllegalArgumentException} to be handled
     * @param request {@link HttpServletRequest} object referring to the current request.
