...
public class VisitController implements VisitsApi {
    ...
    @PreAuthorize("hasAnyRole(@roles.ADMIN, @roles.OWNER_ADMIN)")
    @Override
    public ResponseEntity<VisitDto> addVisit(@Valid VisitFieldsDto visitFieldsDto) {
    ...
    @PreAuthorize("hasAnyRole(@roles.ADMIN, @roles.OWNER_ADMIN)")
    @Override
    public ResponseEntity<VisitDto> updateVisit(UUID visitId, @Valid VisitFieldsDto visitFieldsDto) {
        Optional<Visit> visitOpt = visitService.findById(visitId);
        if (visitOpt.isEmpty()) {
    ...
    @PreAuthorize("hasAnyRole(@roles.ADMIN, @roles.OWNER_ADMIN)")
    @Override
    public ResponseEntity<VisitPrescriptionDto> addVisitPrescription(UUID visitId, @Valid VisitPrescriptionFieldsDto visitPrescriptionFieldsDto) {
