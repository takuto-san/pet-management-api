...
('jiro', '$2a$10$ymaklWBnpBKlgdMgkjWVF.GMGyvH8aDuTK.glFOaKw712LHtRRymS', TRUE,
 '次郎', '佐藤', 'ジロウ', 'サトウ',
 'jiro.sato@example.com', '460-0001', '愛知県', '名古屋市中区', '栄1-1', '070-5555-6666'),

('yumi', '$2a$10$ymaklWBnpBKlgdMgkjWVF.GMGyvH8aDuTK.glFOaKw712LHtRRymS', TRUE,
 '由美', '田中', 'ユミ', 'タナカ',
 'yumi.tanaka@example.com', '810-0001', '福岡県', '福岡市中央区', '天神1-1', '090-7777-8888'),

('ichiro', '$2a$10$ymaklWBnpBKlgdMgkjWVF.GMGyvH8aDuTK.glFOaKw712LHtRRymS', TRUE,
 '一郎', '高橋', 'イチロウ', 'タカハシ',
 'ichiro.takahashi@example.com', '060-0001', '北海道', '札幌市中央区', '大通1-1', '080-9999-0000'),
...
WHERE r.name = 'owner'
  AND u.username IN ('taro', 'hanako', 'jiro', 'yumi', 'ichiro', 'kenji')
ON CONFLICT DO NOTHING;

-- 管理者ユーザーを admin ロールに紐付け
INSERT INTO user_roles (user_id, role_id)
SELECT u.id, r.id
FROM users u, roles r
WHERE r.name = 'admin'
